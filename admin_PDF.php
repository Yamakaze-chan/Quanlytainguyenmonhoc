...
<body>
    <div class="row">
        <!--List PDF-->
        <?php include('delete_PDF_file_admin.php') ?>
        <h1 style="text-align:center">Danh sách tài liệu <text style="color:red">PDF</text></h1>
            <h3 style="text-align:center">
                Trang chỉnh sửa tài liệu trên hệ thống dành cho Admin
            </h3>
        <div class="col-7"> 
